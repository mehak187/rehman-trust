...
<?php
 ...
 <!--</script><script>window.location = "https://khass-trust.000webhostapp.com/latest-news-admin.php";-->
 <!--</script>-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                     <a href="latest-news-admin.php"><button type="button" class="btn btn-primary">
                        OK
                    </button></a>
                </div>
            </div>
