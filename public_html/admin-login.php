        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                     <a href="admin-home.php"><button type="button" class="btn btn-primary">
                        OK
                    </button></a>
                </div>
            </div>
...
<?php
    ...
    if(isset($_POST['submit'])) {
        $email = $_POST['email'];
        $pass = $_POST['pass'];
        $sql_email = "SELECT * FROM tbl_admin WHERE email='$email'";
        ...
        if($email_num>0) {
           ...
           // store the password of specific fetched email row in email_pass
            ...
            $_SESSION['a_name'] = $emailrow_fetch['a_name'];
            if($pass == $emailrow_fetch['pass']){
                echo "LOGIN successful";
                echo $emailrow_fetch['pass'];
                ?>
                <script>
