...
<body>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">
                            <a href="add-about-admin.php" class="add-btn">Add</a>
                        </th>
                    </tr>
                </thead>
                <tbody>
    ...
    ?>
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <a href="edit-about-admin.php?Sr=<?php echo $row['Sr'];?>"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="del-about-admin.php?Sr=<?php echo $row['Sr'];?>"><button type="button" class="btn btn-primary" name="del">
                        Delete
                    </button></a>
                </div>
            </div>
...
<script>
	$(document).ready(function(){
       $(".del-btn").click(function () {
    		...
    		$(".modal.conf-modal").css("background", "rgba(0,0,0,0.2)");
